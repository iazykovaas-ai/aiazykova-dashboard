...
TOPICS = [
    {
        ...
        "page": "pages/1_📈_PL_общий.py",
        "title": "📈 PL общий",
        "answer": "Это в разделе **PL общий** — там выручка, валовая / операционная / чистая "
    ...
    },
    {
        ...
        "page": "pages/6_📊_Факторный_анализ.py",
        "title": "📊 Факторный анализ",
        "answer": "Это раздел **Факторный анализ**: два мостика — «Бюджет → Факт» (что развело "
