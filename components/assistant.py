...
def answer_query(query: str) -> dict:
    ...
    if re.fullmatch(r"(привет|здравствуй\w*|хай|hello|hi|добрый день|доброе утро|здаров\w*)[!. ]*", q):
        return {"text": "Привет! Я помогу найти нужный раздел дашборда. "
                        "Спросите про выручку, прибыль, план/факт, клиентов, агентов или сегменты.",
                "page": None, "title": None}
    ...
    return {"text": "Не нашёл точного раздела 🤔 Я знаю про: **Мониторинг**, **Финансовые результаты**, "
                   "**Анализ отклонений**, **Доходность агентов** и **Сегменты**. Попробуйте "
                   "переформулировать — например, «где оборот по клиентам?» или «рейтинг агентов».",
            "page": None, "title": None}
